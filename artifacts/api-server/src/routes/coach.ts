...
router.get("/coach/clients/:clientId", authenticate, requireRole("coach"), async (req, res) => {
  try {
    ...
    res.json({
      ...
      fitnessLevel: privacy.shareContext !== false ? athlete.fitnessLevel : null,
      primaryGoal: privacy.shareContext !== false ? athlete.primaryGoal : null,
      secondaryGoal: privacy.shareContext !== false ? (athlete.secondaryGoal ?? null) : null,
